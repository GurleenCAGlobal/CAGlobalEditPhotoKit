...
extension UIImage {
    public func cropped(withCropperState cropperState: CropperState) -> UIImage? {
        ...
        autoreleasepool {
            ...
            let tAxis = cropperState.imageViewTransform
            let xScale: CGFloat = sqrt(tAxis.a * tAxis.a + tAxis.c * tAxis.c)
            let yScale: CGFloat = sqrt(tAxis.b * tAxis.b + tAxis.d * tAxis.d)
    ...
    private class func newTransformedImage(_ transform: CGAffineTransform,
                                           ...
                                           outputWidth: CGFloat,
                                           cropSize: CGSize,
                                           imageViewBoundsSize: CGRect) -> CGImage? {
