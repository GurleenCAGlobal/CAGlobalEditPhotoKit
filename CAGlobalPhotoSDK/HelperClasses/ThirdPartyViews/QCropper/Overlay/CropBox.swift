...
open class CropBox: UIView {
    ...
    override init(frame: CGRect) {
        ...
        clipsToBounds = false
        layer.borderColor = UIColor.init(red: 0 / 255.0, green: 177 / 255.0, blue: 255 / 255.0, alpha: 1).cgColor
        layer.borderWidth = 1
...
extension CropBox {
    class CornerView: UIView {
        ...
        init(_ type: CornerType) {
            ...
            let lineColor: UIColor = UIColor.init(red: 0 / 255.0, green: 177 / 255.0, blue: 255 / 255.0, alpha: 1)
