...
extension Int32 {
  func conversion() -> GLenum {
    return GLuint(self)
  }
  
  func conversion() -> GLboolean {
    return GLboolean(UInt8(self))
  }
}

extension Int {
  func conversion() -> Int32 {
    return Int32(self)
  }
  
  func conversion() -> GLubyte {
    return GLubyte(self)
  }
...
public final class LUTFilter {
  ...
  private func getImageFromBuffer(width: Int, height: Int) -> UIImage {
    ...
    glReadPixels(xAxis, yAxis, GLsizei(width), GLsizei(height), GLenum(GL_RGBA), GLenum(GL_UNSIGNED_BYTE), data)
